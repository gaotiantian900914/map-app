 ...
 * 
 * 修改详情：
 * 1. 理想充电站命名格式改为：理想充电站 XXX（如：理想充电站 宝安壹方城）
 * 2. 理想充电站地址格式改为：详细地址（如：宝安区新安街道新湖路 99 号）
 * 3. 位置信息显示详细地址，不再显示"理想汽车充电站 - 宝安区"
 * 4. 添加防缓存 meta 标签到 index.html 和 add-marker.html
 * 5. 优化批量添加功能，添加坐标验证
 * 6. 信息窗口优先使用 marker.description 显示地址
 * 
 * 对标小鹏充电站格式：
 * - 小鹏：小鹏充电站 宝安壹方城 | 宝安区新安街道新湖路 99 号
 * - 理想：理想充电站 宝安壹方城 | 宝安区新安街道新湖路 99 号
 */
...
const AMAP_KEY = 'bc2724beb69ad0edfec338fe5bfd9d5c';
...
// 生成详细位置信息（使用逆地理编码 API）
async function generateDetailedLocation(lat, lng) {
    try {
        // 调用高德地图逆地理编码 API
...
function batchAddIdealChargingStations() {
    try {
        ...
        const chargingStations = [
            ...
            { name: '理想充电站 南山麒麟花园', lat: 22.543900, lng: 113.931300, address: '南山区南头街道麒麟花园' },
